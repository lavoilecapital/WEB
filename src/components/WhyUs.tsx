...
export default function WhyUs() {
  ...
  return (
    <section id="whyus" className="py-20 md:py-24 bg-neutral-900 text-white overflow-x-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map(s => (
                <div key={s.label} className="border border-white/10 p-5">
                  <p className="text-3xl md:text-4xl font-serif font-bold mb-1">{s.num}</p>
          ...
          <div ref={pointsRef} className="flex flex-col gap-4">
            {points.map(p => (
              <div key={p.title} className="flex gap-4 items-start border border-white/10 p-5">
                ...
                <div>
                  <h3 className="font-bold mb-1 text-sm md:text-base">{p.title}</h3>
